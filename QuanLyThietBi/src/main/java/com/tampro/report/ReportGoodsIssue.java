...
public class ReportGoodsIssue extends AbstractXlsView{
	...
	protected void buildExcelDocument(Map<String, Object> model, Workbook workbook, HttpServletRequest request,
		...
		StringBuilder fileName = new StringBuilder("report_Xuat-Hang_");
		...
		row.createCell(5).setCellValue("Người xuất");
