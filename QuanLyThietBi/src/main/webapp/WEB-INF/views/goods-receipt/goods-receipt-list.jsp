...
<div class="right_col" role="main">
	...
	<div class="table-responsive">
		...
		<a href='<c:url value="/goods-receipt/excel-file"></c:url>'><button class="btn btn-default" title="lấy mẫu import"><i class="glyphicon glyphicon-file"></i> Document</button></a>
		 -->
                          ...
                          <c:forEach items="${list}" var="item" varStatus="i"> 
                            ...
                            <td colspan="3" class="last text-center">
	                            ...
	                            <a href='<c:url value="/goods-receipt/view/${item.id}"></c:url>' class="btn btn-primary"><i class="glyphicon glyphicon-eye-open"></i></a> 
	                             <a href='<c:url value="/goods-receipt/edit/${item.id}"></c:url>' class="btn btn-warning"><i class="glyphicon glyphicon-edit"></i></a>  
		...
		<div id="excel-modal" class="modal fade">
			<div class="modal-dialog">
				<div class="modal-content">
				  <form action='<c:url value="/manage/goods-receipt/import-excel"></c:url>' method="post" enctype="multipart/form-data">
