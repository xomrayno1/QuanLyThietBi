							...
							<div class="x_panel">
								<div class="x_content">
									...
									<form:form servletRelativeAction="/user/save"  modelAttribute="submitForm" method="POST" cssClass="form-horizontal form-label-left">
										...
										<c:if test="${submitForm.id == 0  || viewOnly}">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">												
												<c:choose>
													...
													<c:otherwise>
														<c:choose>
															<c:when test="${submitForm.role == 1}">
																<input value="Admin" class="form-control" readonly="readonly">
															</c:when>
															<c:otherwise>
																<input value="User" class="form-control" readonly="readonly">
															</c:otherwise>
														</c:choose>
													</c:otherwise>
												</c:choose>
